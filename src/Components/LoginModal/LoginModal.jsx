            ...
            <div className="LoginModel">
                <div className="left">
                    <div className="left-container">
                        ...
                        <p className='Login-des'>Get access to your Orders, Wishlists and Recommendations</p>
                    </div>
                </div>
                <div className="right">
                    <input type="email" className='Login-input' placeholder='Enter Email' required value={email} onChange={(e) => setEmail(e.target.value)} />
